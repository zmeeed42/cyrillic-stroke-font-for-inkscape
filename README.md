...
## Font Origin
This font is derived from **MADE Likes Script** (available at [fonts-online.ru](https://fonts-online.ru/fonts/made-likes-script)), converted and adapted into a single-line stroke format with full Cyrillic character support.

## Installation
1. Ensure you have the [Inkscape Stroke Font extension](https://github.com/Shriinivas/inkscapestrokefont) installed
2. Place the `MADE Likes Script.svg`  file in the appropriate directory:
      - Windows: `%APPDATA%\Roaming\inkscape\extensions\strokefontdata\`
 3. Restart Inkscape

## Features
- **Single-line stroke design** - Each character is composed of single, continuous paths
- **Cyrillic script support** - Includes characters for Russian and other Cyrillic-based languages
- **Inkscape Stroke Font compatible** - Ready to use with the [inkscapestrokefont](https://github.com/Shriinivas/inkscapestrokefont) extension
- **Vector format** - Clean, scalable paths suitable for fabrication tools

## Usage in Inkscape
According with instructions for the [Inkscape Stroke Font extension](https://github.com/Shriinivas/inkscapestrokefont)

## Character Set
The font includes:
- Uppercase and lowercase russian alphabet (А-Я, а-я)
- Uppercase and lowercase english alphabet (A-Z, a-z) 
- Basic punctuation and symbols
- Numerals (0-9)

## Applications
- **CNC machining & engraving** - Perfect for toolpath generation
...
- Inkscape Stroke Font extension: [Shriinivas](https://github.com/Shriinivas/inkscapestrokefont)

## Contributing
Contributions, improvements, and bug reports are welcome! Please open an issue or pull request if you have suggestions or encounter any problems.
